...
const settingsKeys = new Set(['ssid', 'host', 'cameraUrl', 'cameraSource', 'cameraOrientation', 'cameraOrientationMain', 'cameraOrientationFlow', 'positionAssistEnabled', 'positionAssistCalibrated', 'assistRollSign', 'assistPitchSign', 'profile', 'mode', 'response', 'protocolConfirmed']);
